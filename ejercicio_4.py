...
if __name__ == '__main__':
    ...
    list_numeros = [int(x) if (x.isdigit() is True) else 0 for x in list_numeros_str]
    
    print(list_numeros)

    print(list_numeros_str)

# estoy confundida... no tendria que deb¡volverme el valor int sin las comas ???
